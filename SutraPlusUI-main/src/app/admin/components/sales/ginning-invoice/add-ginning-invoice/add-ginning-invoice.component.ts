...
@Component({
  selector: 'app-add-ginning-invoice',
  templateUrl: './add-ginning-invoice.component.html',
  styleUrls: ['./add-ginning-invoice.component.scss']
})
export class AddGinningInvoiceComponent implements OnInit {
