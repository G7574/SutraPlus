...
@Component({
  selector: 'app-ginning-invoice-dashboard',
  templateUrl: './ginning-invoice-dashboard.component.html',
  styleUrls: ['./ginning-invoice-dashboard.component.scss'],
})
export class GinningInvoiceDashboardComponent implements OnInit {
  invoiceList: any[] = [];
  error: any;
  userDetails: any;
  financialYear: any;
  ...
  addParty(): void {
    //this.router.navigate(['/admin/GinningInvoice'])
  ...
  onEdit(data: any): void {
    ...
    this.router.navigate(['/admin/view-ginning-invoice']);
  }
