...
@Component({
  selector: 'app-view-ginning-invoice',
  templateUrl: './view-ginning-invoice.component.html',
  styleUrls: ['./view-ginning-invoice.component.scss']
})
export class ViewGinningInvoiceComponent implements OnInit {
  invoiceData: any;
